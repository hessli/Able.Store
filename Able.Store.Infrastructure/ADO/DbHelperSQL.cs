...
namespace Able.Store.Infrastructure.ADO
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        //public static string connectionString = "Data Source=192.168.1.18;Initial Catalog=HKdemoDB;Persist Security Info=True;User ID=sa;Password=123";
        public static string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["ProviderConnectionString"].ConnectionString; //如果要换数据库，你可以参考SysManage       		
        public DbHelperSQL()
        {
        ...
        /// <returns></returns>
        public static DataSet Query(string SQLString, int startRecord, int maxRecord, string srcTable)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                DataSet ds = new DataSet();
        ...
        /// <returns></returns>
        public static DataSet Query(string SQLString, int startRecord, int maxRecord, string srcTable, params MySqlParameter[] cmdParms)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                MySqlCommand cmd = new MySqlCommand();
        ...
        /// <param name="tableName"></param>
        /// <returns></returns>
        public static DataSet RunProcedure(string storedProcName, IDataParameter[] parameters, int startRecord, int maxRecord, string tableName)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                DataSet dataSet = new DataSet();
        ...
        #region 执行事务
        public static DataSet Query(MySqlCommand cmd, MySqlParameter[] parameters)
        {
            DataSet ds = new DataSet();
            try
            {
        ...
        public static object GetSingle(MySqlCommand cmd, MySqlParameter[] parameters)
        {
        ...
        public static ArrayList GetArrayList(MySqlCommand cmd,params MySqlParameter[] parameters)
        {
        ...
        public static int ExecuteTran(MySqlCommand cmd, MySqlParameter[] parameters)
        {
            int ReturnValue = 0;
            try
            {
        ...
        public static int ExecuteTranByUpdate(MySqlCommand cmd, MySqlParameter[] parameters)
        {
            try
            {
                foreach (MySqlParameter parameter in parameters)
        ...
        public static int ExecuteTrans(MySqlCommand cmd, MySqlParameter[] parameters)
        {
            int ReturnValue = 0;
            try
            {
        ...
        public static int ExecuteTranNO(MySqlCommand cmd, MySqlParameter[] parameters)
        {
            int ReturnValue = 0;
            try
            {
