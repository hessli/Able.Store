...
//发送请求前
	...
	var load_height = document.documentElement.clientHeight;
...
//跳转授权
	...
	for (var i=0;i<jump.length;i++ ){
		...
		if ( jumps[0] == "unionid" ){
			window.unionid = decodeURIComponent(jumps[1]);
		}
	}
